...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Typist = function (_Component) {
	  ...
	  _createClass(Typist, [{
	    ...
	    value: function render() {
	      ...
	      var _utils$cloneElementWi = utils.cloneElementWithSpecifiedText({
	        element: this.props.children,
	        textLines: this.state.textLines,
	        linesToType: this.linesToType
	      }),
	          innerTree = _utils$cloneElementWi.innerTree,
	          rest = _utils$cloneElementWi.rest;
	...
	Typist.propTypes = {
	  ...
	  noShift: _propTypes2.default.bool
	};
	Typist.defaultProps = {
	  className: '',
	  avgTypingDelay: 70,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function cloneElementWithSpecifiedText(_ref) {
	  var element = _ref.element,
	      ...
	      linesToType = _ref.linesToType;

	  if (!element) {
	    return undefined;
	  }

	  var renderedText = cloneElementWithSpecifiedTextAtIndex(element, textLines, 0)[0];

	  // @todo: Make it work with backspace element, delay element and other children elements
	  var currentLine = textLines.length - 1;
	  var restText = void 0;
	  if (currentLine < 0 || _react2.default.isValidElement(linesToType[currentLine])) {
	    restText = '';
	  } else {
	    restText = linesToType[currentLine].slice(textLines[currentLine].length);
	  }

	  var rest = _react2.default.createElement('span', { style: { visibility: 'hidden' } }, restText);
